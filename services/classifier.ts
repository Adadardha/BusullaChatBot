...
/**
 * Trait dimensions used as the feature space.
 * Each quiz answer votes on one or more of these dimensions.
 */
const TRAITS = [
  'analitik',      // 0 - logical / analytical thinking
  'krijues',       // 1 - creative / artistic
  'social',        // 2 - people-oriented / communicative
  'organizues',    // 3 - organised / structured
  'teknik',        // 4 - technical / engineering mindset
  'sipërmarrës',   // 5 - entrepreneurial / business drive
  'kujdesar',      // 6 - caring / service-oriented
  'lider',         // 7 - leadership / management
  'hulumtues',     // 8 - research / curiosity
  'vizual',        // 9 - visual / design sensibility
] as const;
...
/**
 * Maps each quiz option text to a partial trait vector.
 * Key is a lowercase substring that uniquely identifies the option.
 */
...
/** Career profiles: trait weights defining each career's ideal candidate. */
